...
public class LabGrade {
    public static void main (String[] args) {
      // Declare constants
      double inWeight;  // in-class weight WAS 60%
      double outWeight; // out-of-class weight WAS 40%
      ...
      System.out.print("What weight should be assigned to in-class work for the grading process? ");
      inWeight = scan.nextDouble();
      System.out.print("What weight should be assigned to out-of-class work for the grading process? ");
